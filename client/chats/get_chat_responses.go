...
/* polymorph GetChatOKBody description false */

/* polymorph GetChatOKBody error_code false */

/* polymorph GetChatOKBody ok false */

/* polymorph GetChatOKBody result false */
...
func (o *GetChatOKBody) validateDescription(formats strfmt.Registry) error {

	if err := validate.Required("getChatOK"+"."+"description", "body", o.Description); err != nil {
		return err
	}
...
func (o *GetChatOKBody) validateErrorCode(formats strfmt.Registry) error {

	if err := validate.Required("getChatOK"+"."+"error_code", "body", o.ErrorCode); err != nil {
		return err
	}
...
func (o *GetChatOKBody) validateOk(formats strfmt.Registry) error {

	if err := validate.Required("getChatOK"+"."+"ok", "body", o.Ok); err != nil {
		return err
	}
...
func (o *GetChatOKBody) validateResult(formats strfmt.Registry) error {

	if err := validate.Required("getChatOK"+"."+"result", "body", o.Result); err != nil {
		return err
	}
	...
	if o.Result != nil {
		...
		if err := o.Result.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getChatOK" + "." + "result")
			}
			return err
		}
	}
