...
// source: models/inline_query_result_audio.go
// DO NOT EDIT!
...
func (mj *InlineQueryResultAudio) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	_ = err
	buf.WriteByte('{')
	if mj.AudioDuration != 0 {
		buf.WriteString(`"audio_duration":`)
		fflib.FormatBits2(buf, uint64(mj.AudioDuration), 10, mj.AudioDuration < 0)
		buf.WriteByte(',')
	}
	if mj.AudioURL != nil {
		buf.WriteString(`"audio_url":`)
		fflib.WriteJsonString(buf, string(*mj.AudioURL))
	} else {
		buf.WriteString(`"audio_url":null`)
	}
	buf.WriteByte(',')
	if len(mj.Caption) != 0 {
...
const (
	...
	ffj_t_InlineQueryResultAudio_AudioDuration

	ffj_t_InlineQueryResultAudio_AudioURL

	ffj_t_InlineQueryResultAudio_Caption
...
var ffj_key_InlineQueryResultAudio_AudioDuration = []byte("audio_duration")

var ffj_key_InlineQueryResultAudio_AudioURL = []byte("audio_url")

var ffj_key_InlineQueryResultAudio_Caption = []byte("caption")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffj_key_InlineQueryResultAudio_AudioDuration, kn) {
						currentKey = ffj_t_InlineQueryResultAudio_AudioDuration
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffj_key_InlineQueryResultAudio_AudioURL, kn) {
						currentKey = ffj_t_InlineQueryResultAudio_AudioURL
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'c':
					...
					if bytes.Equal(ffj_key_InlineQueryResultAudio_Caption, kn) {
						currentKey = ffj_t_InlineQueryResultAudio_Caption
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 't':
					...
					if bytes.Equal(ffj_key_InlineQueryResultAudio_Title, kn) {
						currentKey = ffj_t_InlineQueryResultAudio_Title
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffj_key_InlineQueryResultAudio_Type, kn) {
				...
				if fflib.SimpleLetterEqualFold(ffj_key_InlineQueryResultAudio_Caption, kn) {
					currentKey = ffj_t_InlineQueryResultAudio_Caption
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffj_key_InlineQueryResultAudio_AudioURL, kn) {
					currentKey = ffj_t_InlineQueryResultAudio_AudioURL
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffj_key_InlineQueryResultAudio_AudioDuration, kn) {
					currentKey = ffj_t_InlineQueryResultAudio_AudioDuration
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_InlineQueryResultAudio_AudioDuration:
					goto handle_AudioDuration

				case ffj_t_InlineQueryResultAudio_AudioURL:
					goto handle_AudioURL

				case ffj_t_InlineQueryResultAudio_Caption:
					goto handle_Caption
...
handle_AudioDuration:
	...
	/* handler: uj.AudioDuration type=int64 kind=int64 quoted=false*/
...
handle_AudioURL:
	...
	/* handler: uj.AudioURL type=string kind=string quoted=false*/
