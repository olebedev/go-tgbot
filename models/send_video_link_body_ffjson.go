...
// source: models/send_video_link_body.go
// DO NOT EDIT!
...
func (mj *SendVideoLinkBody) MarshalJSON() ([]byte, error) {
...
func (mj *SendVideoLinkBody) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if mj == nil {
		buf.WriteString("null")
		return nil
	}
...
const (
	...
	ffj_t_SendVideoLinkBody_ChatID

	ffj_t_SendVideoLinkBody_DisableNotification

	ffj_t_SendVideoLinkBody_Duration

	ffj_t_SendVideoLinkBody_Height

	ffj_t_SendVideoLinkBody_ReplyMarkup
...
var ffj_key_SendVideoLinkBody_ChatID = []byte("chat_id")

var ffj_key_SendVideoLinkBody_DisableNotification = []byte("disable_notification")

var ffj_key_SendVideoLinkBody_Duration = []byte("duration")

var ffj_key_SendVideoLinkBody_Height = []byte("height")
...
func (uj *SendVideoLinkBody) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return uj.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

func (uj *SendVideoLinkBody) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error = nil
	currentKey := ffj_t_SendVideoLinkBodybase
	_ = currentKey
	...
	for {
			...
			if len(kn) <= 0 {
				...
				case 'c':
					...
					if bytes.Equal(ffj_key_SendVideoLinkBody_Caption, kn) {
						currentKey = ffj_t_SendVideoLinkBody_Caption
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffj_key_SendVideoLinkBody_ChatID, kn) {
						currentKey = ffj_t_SendVideoLinkBody_ChatID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'd':
					...
					if bytes.Equal(ffj_key_SendVideoLinkBody_DisableNotification, kn) {
						currentKey = ffj_t_SendVideoLinkBody_DisableNotification
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffj_key_SendVideoLinkBody_Duration, kn) {
						currentKey = ffj_t_SendVideoLinkBody_Duration
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'h':
					...
					if bytes.Equal(ffj_key_SendVideoLinkBody_Height, kn) {
						currentKey = ffj_t_SendVideoLinkBody_Height
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					if bytes.Equal(ffj_key_SendVideoLinkBody_ReplyMarkup, kn) {
						currentKey = ffj_t_SendVideoLinkBody_ReplyMarkup
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffj_key_SendVideoLinkBody_ReplyToMessageID, kn) {
						currentKey = ffj_t_SendVideoLinkBody_ReplyToMessageID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffj_key_SendVideoLinkBody_ReplyToMessageID, kn) {
					currentKey = ffj_t_SendVideoLinkBody_ReplyToMessageID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffj_key_SendVideoLinkBody_ReplyMarkup, kn) {
					currentKey = ffj_t_SendVideoLinkBody_ReplyMarkup
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffj_key_SendVideoLinkBody_Height, kn) {
					currentKey = ffj_t_SendVideoLinkBody_Height
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffj_key_SendVideoLinkBody_Duration, kn) {
					currentKey = ffj_t_SendVideoLinkBody_Duration
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffj_key_SendVideoLinkBody_DisableNotification, kn) {
					currentKey = ffj_t_SendVideoLinkBody_DisableNotification
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffj_key_SendVideoLinkBody_ChatID, kn) {
					currentKey = ffj_t_SendVideoLinkBody_ChatID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffj_key_SendVideoLinkBody_Caption, kn) {
					currentKey = ffj_t_SendVideoLinkBody_Caption
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_SendVideoLinkBody_ChatID:
					goto handle_ChatID

				case ffj_t_SendVideoLinkBody_DisableNotification:
					goto handle_DisableNotification

				case ffj_t_SendVideoLinkBody_Duration:
					goto handle_Duration

				case ffj_t_SendVideoLinkBody_Height:
					goto handle_Height

				case ffj_t_SendVideoLinkBody_ReplyMarkup:
				...
				case ffj_t_SendVideoLinkBodyno_such_key:
