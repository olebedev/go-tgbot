...
var ffj_key_Video_Thumb = []byte("thumb")
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 't':
					...
					if bytes.Equal(ffj_key_Video_Thumb, kn) {
						currentKey = ffj_t_Video_Thumb
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.SimpleLetterEqualFold(ffj_key_Video_Thumb, kn) {
					currentKey = ffj_t_Video_Thumb
					state = fflib.FFParse_want_colon
					goto mainparse
				}
