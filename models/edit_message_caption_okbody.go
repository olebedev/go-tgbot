...
func (m *EditMessageCaptionOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EditMessageCaptionOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EditMessageCaptionOKBody) UnmarshalBinary(b []byte) error {
