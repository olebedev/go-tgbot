...
// source: models/inline_query_result_voice.go
// DO NOT EDIT!
...
func (mj *InlineQueryResultVoice) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	buf.WriteByte(',')
	if mj.VoiceDuration != 0 {
		buf.WriteString(`"voice_duration":`)
		fflib.FormatBits2(buf, uint64(mj.VoiceDuration), 10, mj.VoiceDuration < 0)
		buf.WriteByte(',')
	}
	if mj.VoiceURL != nil {
		buf.WriteString(`"voice_url":`)
		fflib.WriteJsonString(buf, string(*mj.VoiceURL))
	} else {
		buf.WriteString(`"voice_url":null`)
	}
	buf.WriteByte('}')
	return nil
}
...
const (
	...
	ffj_t_InlineQueryResultVoice_Caption
	...
	ffj_t_InlineQueryResultVoice_VoiceDuration

	ffj_t_InlineQueryResultVoice_VoiceURL
)

var ffj_key_InlineQueryResultVoice_Caption = []byte("caption")
...
var ffj_key_InlineQueryResultVoice_VoiceDuration = []byte("voice_duration")

var ffj_key_InlineQueryResultVoice_VoiceURL = []byte("voice_url")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'c':
					...
					if bytes.Equal(ffj_key_InlineQueryResultVoice_Caption, kn) {
						currentKey = ffj_t_InlineQueryResultVoice_Caption
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 't':
					...
					if bytes.Equal(ffj_key_InlineQueryResultVoice_Title, kn) {
						currentKey = ffj_t_InlineQueryResultVoice_Title
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffj_key_InlineQueryResultVoice_Type, kn) {
				...
				case 'v':
					...
					if bytes.Equal(ffj_key_InlineQueryResultVoice_VoiceDuration, kn) {
						currentKey = ffj_t_InlineQueryResultVoice_VoiceDuration
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffj_key_InlineQueryResultVoice_VoiceURL, kn) {
						currentKey = ffj_t_InlineQueryResultVoice_VoiceURL
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.AsciiEqualFold(ffj_key_InlineQueryResultVoice_VoiceURL, kn) {
					currentKey = ffj_t_InlineQueryResultVoice_VoiceURL
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffj_key_InlineQueryResultVoice_VoiceDuration, kn) {
					currentKey = ffj_t_InlineQueryResultVoice_VoiceDuration
					state = fflib.FFParse_want_colon
					goto mainparse
				}
				...
				if fflib.SimpleLetterEqualFold(ffj_key_InlineQueryResultVoice_Caption, kn) {
					currentKey = ffj_t_InlineQueryResultVoice_Caption
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_InlineQueryResultVoice_Caption:
					goto handle_Caption
				...
				case ffj_t_InlineQueryResultVoice_VoiceDuration:
					goto handle_VoiceDuration

				case ffj_t_InlineQueryResultVoice_VoiceURL:
...
handle_VoiceDuration:
	...
	/* handler: uj.VoiceDuration type=int64 kind=int64 quoted=false*/
...
handle_VoiceURL:
	...
	/* handler: uj.VoiceURL type=string kind=string quoted=false*/
